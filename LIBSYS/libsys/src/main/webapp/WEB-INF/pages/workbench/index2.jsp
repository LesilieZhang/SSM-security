	...
	<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
		...
		<div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
			<ul id="no1" class="nav nav-pills nav-stacked">
				...
				<li class="liClass"><a href="workbench/lendbook/index.do" target="workareaFrame"><span class="glyphicon glyphicon-book"></span> 查询图书</a></li>
				<li class="liClass"><a href="workbench/lendmain/index.do" target="workareaFrame"><span class="glyphicon glyphicon-user"></span> 借阅图书</a></li>
				<li class="liClass"><a href="workbench/return/index.do" target="workareaFrame"><span class="glyphicon glyphicon-play-circle"></span> 归还图书</a></li>
			</ul>
